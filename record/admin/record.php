...
<html lang = "eng">
	...
	<body style="background-color:#000033">
		...
		<div class = "container-fluid" style = "margin-top:70px;">
				...
				<li  class = "active"><a  href = "record.php"><span class="glyphicon glyphicon-folder-open"> Login </a></li>
...
<div class="overlay" id="overlay" hidden>
    <div class="confirm-box">
	 ...
	 <a href = "dal.php"> <button class="btn2" onclick="isConfirm(true)">Yes</button></a>
