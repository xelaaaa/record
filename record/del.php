...
p.thicker {
  ...
  font-size: 50px;
	...
	<center style="background-color:#80bfff;"><h1 style="color:#000000">Logout</h1></center>
		...
		<div class = "container-fluid">	
			...
			<h5  class = "nav navbar-nav navbar-right"><a style="color: blue" href = "index.php"><span class="glyphicon glyphicon-refresh">Login</span></a></h5>
